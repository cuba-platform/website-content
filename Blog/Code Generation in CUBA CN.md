...
所以，CUBA 选择了在构建时生成代码。生成的代码量并不庞大，目标 class 也仅限于实体，所以对于这中特殊的情况，代码生成比较简单，目前为止还没发生阻塞性的问题。
...
所以，如果你计划创建自己的框架，或者在已有框架中引入代码生成，考虑一下这项技术的强大，以及...脆弱性。尝试生成简单的代码，并未所有的生成步骤和条件记录文档，因为任何 API 中的改动都会很容易破坏生成过程。
